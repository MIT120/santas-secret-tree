...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var tw: TypeWriter
    private var myClipboard: ClipboardManager? = null
    private var input: String = "oiwcdpbseqgxryfmlpktnupvza\n" +
    ...
    fun checkAnswer(v: View) {
        val submission = answerEditText.text.toString()
    ...
    fun copyText(view: View) {
        var clip = ClipData.newPlainText("text", input)
